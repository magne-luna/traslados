# Autorización Gestión

## Purpose
Defines authorization form with state management, retroactive dating, and monthly quota fields for presupuestos.
...
- **THEN** el archivo se sube al bucket `documentos-autorizaciones` y la fila se actualiza con su referencia, su nombre y su fecha de carga reales
...
- **THEN** al terminar la autorización referencia únicamente el archivo nuevo, con su propio nombre y fecha de carga
