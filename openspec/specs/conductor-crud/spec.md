...
## Purpose
Define los requisitos de la pantalla de alta, edición y listado de conductores: datos personales mínimos, restricciones de perfil tipadas y exclusión deliberada del sistema de autenticación (RN-GL-03, US-600).
## Requirements
