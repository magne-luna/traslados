...
Define los tipos TypeScript del dominio de flota (vehículos, gastos, habilitaciones, mantenimientos)
y el contrato `VehiculoRepository` que consume el resto del módulo Vehículos.
## Requirements
