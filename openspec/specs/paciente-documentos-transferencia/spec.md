...
de la lista de ítems vigente del bloque donde está. Esto puede ocurrir tras una reasignación hacia una
actividad cuyo checklist no incluye ese ítem, o por cualquier otro drift entre el `itemId` de un
documento y la lista de ítems configurada (por ejemplo, un ítem borrado del checklist de una obra social
con documentos ya cargados contra él).
