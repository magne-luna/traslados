# Checklist por Tipo de Actividad

## Purpose

Define los requisitos para la pantalla de administración de ítems documentales requeridos por cada tipo de actividad del paciente (escuela, escuela especial, terapia, CET, otro). Esta configuración es **global por tipo de actividad**, no por combinación de obra social y tipo. Los ítems se almacenan en el catálogo compartido `obra_social.tipos_documento`, reutilizado de la configuración de checklists por obra social.
