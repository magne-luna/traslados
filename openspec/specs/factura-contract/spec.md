...
> Nota de archivo: esta versión del requerimiento incorpora la extensión aditiva de `CobroRepository.list()` introducida por `C-11` (dashboard-ui, `MODIFIED Requirements` sobre `factura-contract`) sobre la definición original de `facturacion-ui`.
