...
El sistema SHALL mantener, **dentro de cada actividad**, todo el comportamiento documental ya especificado: los ítems propios del tipo de esa actividad (no los de la obra social), la cardinalidad múltiple sin sobrescritura por ítem, la distinción del documento vigente, y la previsualización por documento puntual.
