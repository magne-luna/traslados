...
- [x] 7.9 Commit(s) en Conventional Commits (`feat(pacientes): …`), partidos si el diff excede el presupuesto de revisión de ~400 líneas por PR. → Hecho: 4 commits (`ebf2895` listado/resumen/formulario, `d0d6cea` editores anidados, `9254d2d` documentos + aviso, `2f47d4a` docs/tasks/CHANGES.md), autorizados explícitamente por la usuaria.
