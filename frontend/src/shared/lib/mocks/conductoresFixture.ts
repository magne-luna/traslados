...
export function buildConductoresFixture(): Conductor[] {
  return [
    ...
    {
      // Restricción de perfil redactada dentro de `observaciones` (D6-B, tasks.md 2C.6): el
      // catálogo cerrado se eliminó del dominio, el docx modela esto como texto libre + asignación
      // semanal vigente a un vehículo real del fixture de flota (vehiculo-etios).
      id: 'conductor-perez',
      apellido: 'Pérez',
      nombre: 'Carlos',
      documento: '15789456',
      ...
      cuil: '20-15789456-9',
      estado: 'operando',
      observaciones: 'No traslada pacientes con carga física: no trasladar con silla rígida ni asistencia de carga física.',
      asignaciones: [{ id: 'asignacion-perez-1', vehiculoId: 'vehiculo-etios', semana: '2026-W30' }],
    },
    {
      // Fuera de servicio (licencia médica): sin asignación vigente, sin observaciones.
      id: 'conductor-diaz',
      apellido: 'Díaz',
      nombre: 'Lucía',
      documento: '32112233',
