...
// el AutorizacionRepository vía este context, nunca importan el mock directamente. El único
// lugar que conoce mockAutorizacionRepository es el composition root (PresupuestosRoute).
